...
scoreboard players set heal_amount temp 0
title @s actionbar {"text": "No one here to heal!", "color": "red"}
execute as @a[limit=2,sort=nearest, distance=..20, tag=!active_player] run function aeternum:healer/active_ability/heal/apply
